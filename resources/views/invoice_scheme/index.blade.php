            ...
            <div class="tab-content">
              ...
              <div class="tab-pane" id="tab_2">
               ...
               <div class="tab-pane" id="tab_3">
                <div class="row">
                    <div class="col-md-12">
                        <h4>@lang( 'new_values.discount_text' ) <a class="btn btn-primary pull-right" href="{{action([\App\Http\Controllers\InvoiceLayoutController::class, 'create'])}}">
                                <i class="fa fa-plus"></i> @lang( 'messages.add' )</a></h4>
                    </div>
                    <div class="col-md-12">
                      <div class="table-responsive">

                        {!! Form::open(['url' => action([\App\Http\Controllers\InvoiceSchemeController::class, 'UpdateDiscoount']), 'method' => 'post','id'=> 'updateDiscount']) !!}
                            @if($discount->count() > 0)
