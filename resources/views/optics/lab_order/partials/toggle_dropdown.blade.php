...
<li>
    <a href="#" class="print-order" data-href="{{ action([\App\Http\Controllers\Optics\LabOrderController::class, 'print'], [$id]) }}">
...
<li>
    ...
    <a href="#" class="print-order" data-href="{{ action([\App\Http\Controllers\Optics\LabOrderController::class, 'changeStatusAndPrint'], [$id, $step->step_id]) }}">
    @elseif ($step->step->transfer_sheet == 1)
    <a href="#" class="transfer-order" data-href="{{ action([\App\Http\Controllers\Optics\LabOrderController::class, 'changeStatusAndTransfer'], [$id, $step->step_id]) }}">
    @elseif ($step->step->second_time == 1)
    <a href="#" class="copy-order" data-href="{{ action([\App\Http\Controllers\Optics\LabOrderController::class, 'changeStatusAndCopy'], [$id, $step->step_id]) }}">
    @elseif ($step->step->material_download == 1)
    <a href="#" class="edit-order" data-href="{{ action([\App\Http\Controllers\Optics\LabOrderController::class, 'changeStatusAndEdit'], [$id, $step->step_id]) }}">
    @else
