    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $cat_total_initial = 0;
                $cat_total_purchase = 0;
                $cat_total_in_transf = 0;
                $cat_total_in_adjust = 0;
                $cat_total_in_return = 0;
                $cat_total_sell = 0;
                $cat_total_out_transf = 0;
                $cat_total_out_adjust = 0;
                $cat_total_out_return = 0;
                $cat_total_stock = 0;
                ...
                foreach ($this->categories as $c) {
                    $cat_total_initial += $c->initial_inventory;
                    $cat_total_purchase += $c->purchases;
                    $cat_total_in_transf += $c->input_stock_adjustments;
                    $cat_total_in_adjust += $c->input_stock_adjustments;
                    $cat_total_in_return += $c->sell_returns;
                    $cat_total_sell += $c->sales;
                    $cat_total_out_transf += $c->sell_transfers;
                    $cat_total_out_adjust += $c->output_stock_adjustments;
                    $cat_total_out_return += $c->purchase_returns;
                    $cat_total_stock += $c->stock;
                    ...
                    if ($count == $counter) {
                        ...
                        /* sum to totals */
                        $total_initial += $cat_total_initial;
                        $total_purchase += $cat_total_purchase;
                        $total_in_transf += $cat_total_in_transf;
                        $total_in_adjust += $cat_total_in_adjust;
                        $total_in_return += $cat_total_in_return;
                        $total_sell += $cat_total_sell;
                        $total_out_transf += $cat_total_out_transf;
                        $total_out_adjust += $cat_total_out_adjust;
                        $total_out_return += $cat_total_out_return;
