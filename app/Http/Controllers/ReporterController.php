...
class ReporterController extends Controller
{
    ...
    public function getPurchasesBook(Request $request)
    {
        ...
        $lines = DB::select(
            ...
            [$initial_date, $final_date, $business_id, $location_id]
        );
    ...
    public function getHistoryPurchaseClientsReport(Request $request)
    {
        ...
        // storage procedures
        $lines = DB::select('CALL get_purchases_clients(?,?,?,?,?)', [$initial_date, $final_date, $business_id, $product_id, $customer_id]);
        // Header info
        $business = Business::where('id', $business_id)->first();
    ...
    public function exportAnnex1(Request $request)
    {
        ...
        $lines = DB::select(
            'CALL annex_1(?, ?, ?, ?, ?)',
            [$initial_date, $final_date, $location_id, $business_id, $annex_number]
        );
    ...
    public function exportAnnex7(Request $request)
    {
        ...
        $lines = DB::select(
            'CALL annex_7(?, ?, ?, ?)',
            [$initial_date, $final_date, $business_id, $annex_number]
        );
