...
class BankTransactionController extends Controller
{
    ...
    public function getBankReconciliation(Request $request)
    {
        ...
        foreach ($imported_file as $key => $value) {
            ...
            $row_status = '';
            $row_description = $transaction_description;
            $row_id = 0;
            $row_system_amount = null;
